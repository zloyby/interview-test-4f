...
public interface RequestsTransactionRepository extends CrudRepository<RequestsTransactionEntity, Long> {
    ...
    @Query("select new cz.finance.hr.test.core.model.response.IpLimitEntityResponse ( " +
    ...
    IpLimitEntityResponse findLimitsByLast(Long countryId, Long regionId, Long cityId, Long timeToEnd);
}
